...
void UART_Write(unsigned char data)  // Output on Terminal ; write char on UART!!!!!!!!
{
...
void UART_Write_Text(char* text) { // Output on Terminal, limit:10 chars ; write string on UART!!!!!!!!
...
void MyusartRead() //write what you type on UART !!!!!!!!!!
{
...
//    SYSTEM_Initialize() ;
    ...
    while(1) {
        /*
         * put this code in interrupt when your want to read string in UART!!!!!!!!!
         */
